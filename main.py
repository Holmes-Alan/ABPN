...
parser.add_argument('--data_dir', type=str, default='/home/liuzhisong/AIM/data/DIV8K')
...
parser.add_argument('--feature_sr', default='HBPN_16x_v3.pth', help='sr pretrained base model')
